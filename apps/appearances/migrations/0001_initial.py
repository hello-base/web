    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('episode', models.ForeignKey(related_name='continuation', blank=True, to='appearances.Episode', null=True)),
                ('groups', models.ManyToManyField(related_name=b'episodes', null=True, to='people.Group', blank=True)),
                ('idols', models.ManyToManyField(related_name=b'episodes', null=True, to='people.Idol', blank=True)),
                ('participating_groups', models.ManyToManyField(related_name=b'episodes_attributed_to', null=True, to='people.Group', blank=True)),
                ('participating_idols', models.ManyToManyField(help_text=b'The remaining idols that are not a member of the given groups.', related_name=b'episodes_attributed_to', null=True, to='people.Idol', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(related_name=b'issues', null=True, to='people.Group', blank=True)),
                ('idols', models.ManyToManyField(related_name=b'issues', null=True, to='people.Idol', blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue', models.ForeignKey(related_name='gallery', to='appearances.Issue')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show', models.ForeignKey(to='appearances.Show')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='issue',
            name='magazine',
            field=models.ForeignKey(related_name='issues', to='appearances.Magazine'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='issue',
            name='participating_groups',
            field=models.ManyToManyField(related_name=b'issues_attributed_to', null=True, to='people.Group', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='issue',
            name='participating_idols',
            field=models.ManyToManyField(help_text=b'The remaining idols that are not a member of the given groups.', related_name=b'issues_attributed_to', null=True, to='people.Idol', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='episode',
            name='show',
            field=models.ForeignKey(to='appearances.Show'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='cardset',
            name='issue',
            field=models.ForeignKey(related_name='sets', to='appearances.Issue'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='card',
            name='cardset',
            field=models.ForeignKey(blank=True, to='appearances.CardSet', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='card',
            name='group',
            field=models.ForeignKey(related_name='cards', blank=True, to='people.Group', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='card',
            name='hp_model',
            field=models.ForeignKey(related_name='cards', verbose_name='H!P model', blank=True, to='people.Idol', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='card',
            name='issue',
            field=models.ForeignKey(related_name='cards', to='appearances.Issue'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='card',
            name='member_of',
            field=models.ForeignKey(related_name='idol', blank=True, to='people.Group', null=True),
            preserve_default=True,
        ),
    ]
