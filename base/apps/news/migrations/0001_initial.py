...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Item'
        db.create_table(u'news_item', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('body', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='item_submissions', null=True, to=orm['accounts.Editor'])),
            ...
            ('via', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('via_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'news', ['Item'])

        # Adding M2M table for field idols on 'Item'
        m2m_table_name = db.shorten_name(u'news_item_idols')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'news.item'], null=False)),
            ('idol', models.ForeignKey(orm[u'people.idol'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'idol_id'])

        # Adding M2M table for field groups on 'Item'
        m2m_table_name = db.shorten_name(u'news_item_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'news.item'], null=False)),
            ('group', models.ForeignKey(orm[u'people.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'group_id'])

        # Adding M2M table for field singles on 'Item'
        m2m_table_name = db.shorten_name(u'news_item_singles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'news.item'], null=False)),
            ('single', models.ForeignKey(orm[u'music.single'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'single_id'])

        # Adding M2M table for field albums on 'Item'
        m2m_table_name = db.shorten_name(u'news_item_albums')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'news.item'], null=False)),
            ('album', models.ForeignKey(orm[u'music.album'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'album_id'])

        # Adding M2M table for field events on 'Item'
        m2m_table_name = db.shorten_name(u'news_item_events')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'news.item'], null=False)),
            ('event', models.ForeignKey(orm[u'events.event'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'event_id'])

        # Adding model 'Update'
        db.create_table(u'news_update', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='updates', to=orm['news.Item'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='update_submissions', null=True, to=orm['accounts.Editor'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('body', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('source_url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ...
        db.send_create_signal(u'news', ['Update'])


    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table(u'news_item')

        # Removing M2M table for field idols on 'Item'
        db.delete_table(db.shorten_name(u'news_item_idols'))

        # Removing M2M table for field groups on 'Item'
        db.delete_table(db.shorten_name(u'news_item_groups'))

        # Removing M2M table for field singles on 'Item'
        db.delete_table(db.shorten_name(u'news_item_singles'))

        # Removing M2M table for field albums on 'Item'
        db.delete_table(db.shorten_name(u'news_item_albums'))

        # Removing M2M table for field events on 'Item'
        db.delete_table(db.shorten_name(u'news_item_events'))

        # Deleting model 'Update'
        db.delete_table(u'news_update')
    ...
    models = {
        ...
        u'news.item': {
            ...
            'albums': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['music.Album']"}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'item_submissions'", 'null': 'True', 'to': u"orm['accounts.Editor']"}),
            'body': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'category': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['events.Event']"}),
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['people.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idols': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['people.Idol']"}),
            'singles': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['music.Single']"}),
        ...
        u'news.update': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'update_submissions'", 'null': 'True', 'to': u"orm['accounts.Editor']"}),
            'body': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'updates'", 'to': u"orm['news.Item']"}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'source_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'via': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'via_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'})
