...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field correlations on 'Item'
        m2m_table_name = db.shorten_name(u'news_item_correlations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'news.item'], null=False)),
            ('correlation', models.ForeignKey(orm[u'correlations.correlation'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'correlation_id'])


    def backwards(self, orm):
        # Removing M2M table for field correlations on 'Item'
        db.delete_table(db.shorten_name(u'news_item_correlations'))
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 14, 0, 0)', 'blank': 'True'}),
        ...
        u'news.item': {
            ...
            'correlations': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['correlations.Correlation']"}),
            ...
            'published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 14, 0, 0)'}),
