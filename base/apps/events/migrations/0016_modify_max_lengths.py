...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'info_link', self.gf('django.db.models.fields.URLField')(default='', max_length=500))

        # Changing field 'Event.nickname'
        db.alter_column(u'events_event', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.nickname'
        db.alter_column(u'events_event', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=30))
