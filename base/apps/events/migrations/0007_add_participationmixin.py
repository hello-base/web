...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field idols on 'Event'
        m2m_table_name = db.shorten_name(u'events_event_idols')
        ...
        db.create_unique(m2m_table_name, ['event_id', 'idol_id'])
        ...
        # Adding M2M table for field participating_idols on 'Event'
        m2m_table_name = db.shorten_name(u'events_event_participating_idols')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'events.event'], null=False)),
            ('idol', models.ForeignKey(orm[u'people.idol'], null=False))
        ...
        # Adding M2M table for field participating_groups on 'Event'
        m2m_table_name = db.shorten_name(u'events_event_participating_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'events.event'], null=False)),
            ('group', models.ForeignKey(orm[u'people.group'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field idols on 'Event'
        db.delete_table(db.shorten_name(u'events_event_idols'))

        # Removing M2M table for field groups on 'Event'
        db.delete_table(db.shorten_name(u'events_event_groups'))

        # Removing M2M table for field participating_idols on 'Event'
        db.delete_table(db.shorten_name(u'events_event_participating_idols'))

        # Removing M2M table for field participating_groups on 'Event'
        db.delete_table(db.shorten_name(u'events_event_participating_groups'))
