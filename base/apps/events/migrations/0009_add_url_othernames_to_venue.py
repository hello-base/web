...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Venue.other_names'
        db.add_column(u'events_venue', 'other_names',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Venue.url'
        db.add_column(u'events_venue', 'url',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Venue.other_names'
        db.delete_column(u'events_venue', 'other_names')

        # Deleting field 'Venue.url'
        db.delete_column(u'events_venue', 'url')
