...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_activity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activity_submissions', null=True, to=orm['accounts.Editor'])),
            ...
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='activity_schedule', to=orm['events.Event'])),
            ('venue', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='activities', null=True, to=orm['events.Venue'])),
            ('venue_known_as', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'events', ['Activity'])

        # Adding M2M table for field edited_by on 'Activity'
        m2m_table_name = db.shorten_name(u'events_activity_edited_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activity', models.ForeignKey(orm[u'events.activity'], null=False)),
            ('editor', models.ForeignKey(orm[u'accounts.editor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activity_id', 'editor_id'])

        # Deleting field 'Event.poster'
        db.delete_column(u'events_event', 'poster')

        # Deleting field 'Event.secondary_info_link'
        db.delete_column(u'events_event', 'secondary_info_link')

        # Adding field 'Event.category'
        db.add_column(u'events_event', 'category',
                      self.gf('django.db.models.fields.CharField')(default='general', max_length=16),
                      keep_default=False)

        # Adding field 'Event.info_link_name'
        db.add_column(u'events_event', 'info_link_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Event.promotional_image'
        db.add_column(u'events_event', 'promotional_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.has_handshake'
        db.add_column(u'events_event', 'has_handshake',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.is_fanclub'
        db.add_column(u'events_event', 'is_fanclub',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.is_international'
        db.add_column(u'events_event', 'is_international',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'events_activity')

        # Removing M2M table for field edited_by on 'Activity'
        db.delete_table(db.shorten_name(u'events_activity_edited_by'))

        # Adding field 'Event.poster'
        db.add_column(u'events_event', 'poster',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.secondary_info_link'
        db.add_column(u'events_event', 'secondary_info_link',
        ...
        # Deleting field 'Event.info_link_name'
        db.delete_column(u'events_event', 'info_link_name')

        # Deleting field 'Event.promotional_image'
        db.delete_column(u'events_event', 'promotional_image')

        # Deleting field 'Event.has_handshake'
        db.delete_column(u'events_event', 'has_handshake')

        # Deleting field 'Event.is_fanclub'
        db.delete_column(u'events_event', 'is_fanclub')

        # Deleting field 'Event.is_international'
        db.delete_column(u'events_event', 'is_international')
    ...
    models = {
        ...
        u'events.activity': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activity_schedule'", 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'venue': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'activities'", 'null': 'True', 'to': u"orm['events.Venue']"}),
