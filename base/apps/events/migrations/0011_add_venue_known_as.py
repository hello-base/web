...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Performance.venue_known_as'
        db.add_column(u'events_performance', 'venue_known_as',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # Changing field 'Performance.name'
        db.alter_column(u'events_performance', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Performance.romanized_name'
        db.alter_column(u'events_performance', 'romanized_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

    def backwards(self, orm):
        # Deleting field 'Performance.venue_known_as'
        db.delete_column(u'events_performance', 'venue_known_as')


        # Changing field 'Performance.name'
        db.alter_column(u'events_performance', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Performance.romanized_name'
        db.alter_column(u'events_performance', 'romanized_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    models = {
        u'accounts.editor': {
            'Meta': {'object_name': 'Editor'},
            'access_token': ('ohashi.db.models.fields.CharField', [], {'blank': 'True'}),
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 6, 0, 0)', 'blank': 'True'}),
