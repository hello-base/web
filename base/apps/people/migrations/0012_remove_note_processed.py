...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Group.note_processed'
        db.delete_column(u'people_group', 'note_processed')

        # Deleting field 'Idol.note_processed'
        db.delete_column(u'people_idol', 'note_processed')


    def backwards(self, orm):
        # Adding field 'Group.note_processed'
        db.add_column(u'people_group', 'note_processed',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Idol.note_processed'
        db.add_column(u'people_idol', 'note_processed',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 0, 0)', 'blank': 'True'}),
