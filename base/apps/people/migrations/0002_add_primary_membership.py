...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Idol.primary_membership'
        db.add_column(u'people_idol', 'primary_membership',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='primary', null=True, to=orm['people.Membership']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Idol.primary_membership'
        db.delete_column(u'people_idol', 'primary_membership_id')
