...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Groupshot'
        db.create_table(u'people_groupshot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos', to=orm['people.Group'])),
            ('kind', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('taken', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'people', ['Groupshot'])

        # Adding model 'Headshot'
        db.create_table(u'people_headshot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('idol', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos', to=orm['people.Idol'])),
            ('kind', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('taken', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal(u'people', ['Headshot'])

        # Adding field 'Idol.photo'
        db.add_column(u'people_idol', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Group.photo'
        db.add_column(u'people_group', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Groupshot'
        db.delete_table(u'people_groupshot')

        # Deleting model 'Headshot'
        db.delete_table(u'people_headshot')

        # Deleting field 'Idol.photo'
        db.delete_column(u'people_idol', 'photo')

        # Deleting field 'Group.photo'
        db.delete_column(u'people_group', 'photo')
