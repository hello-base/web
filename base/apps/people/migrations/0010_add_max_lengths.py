...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Group.name'
        db.alter_column(u'people_group', 'name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Group.former_names'
        db.alter_column(u'people_group', 'former_names', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Group.romanized_name'
        db.alter_column(u'people_group', 'romanized_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.romanized_family_name'
        db.alter_column(u'people_idol', 'romanized_family_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.nicknames'
        db.alter_column(u'people_idol', 'nicknames', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.romanized_alias'
        db.alter_column(u'people_idol', 'romanized_alias', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.romanized_name'
        db.alter_column(u'people_idol', 'romanized_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.birthplace'
        db.alter_column(u'people_idol', 'birthplace', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.given_name'
        db.alter_column(u'people_idol', 'given_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.family_name'
        db.alter_column(u'people_idol', 'family_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.name'
        db.alter_column(u'people_idol', 'name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.romanized_given_name'
        db.alter_column(u'people_idol', 'romanized_given_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Idol.alias'
        db.alter_column(u'people_idol', 'alias', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Staff.name'
        db.alter_column(u'people_staff', 'name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Staff.nicknames'
        db.alter_column(u'people_staff', 'nicknames', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Staff.romanized_family_name'
        db.alter_column(u'people_staff', 'romanized_family_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Staff.family_name'
        db.alter_column(u'people_staff', 'family_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Staff.romanized_alias'
        db.alter_column(u'people_staff', 'romanized_alias', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Staff.alias'
        db.alter_column(u'people_staff', 'alias', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Staff.romanized_name'
        db.alter_column(u'people_staff', 'romanized_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Staff.given_name'
        db.alter_column(u'people_staff', 'given_name', self.gf('ohashi.db.models.fields.CharField')())

        # Changing field 'Staff.romanized_given_name'
        db.alter_column(u'people_staff', 'romanized_given_name', self.gf('ohashi.db.models.fields.CharField')())

    models = {
        u'accounts.editor': {
            'Meta': {'object_name': 'Editor'},
            'access_token': ('ohashi.db.models.fields.CharField', [], {'blank': 'True'}),
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 6, 0, 0)', 'blank': 'True'}),
