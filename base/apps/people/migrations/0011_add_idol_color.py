...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Idol.color'
        db.add_column(u'people_idol', 'color',
                      self.gf('ohashi.db.models.fields.CharField')(default='', max_length=7, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Idol.color'
        db.delete_column(u'people_idol', 'color')
