...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tweet.in_reply_to_user_id_str'
        db.alter_column(u'twitter_tweet', 'in_reply_to_user_id_str', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Tweet.in_reply_to_status_id_str'
        db.alter_column(u'twitter_tweet', 'in_reply_to_status_id_str', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Tweet.in_reply_to_user_id_str'
        db.alter_column(u'twitter_tweet', 'in_reply_to_user_id_str', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Tweet.in_reply_to_status_id_str'
        db.alter_column(u'twitter_tweet', 'in_reply_to_status_id_str', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        u'twitter.tweet': {
            ...
            'in_reply_to_status_id_str': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'in_reply_to_user_id': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'in_reply_to_user_id_str': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
