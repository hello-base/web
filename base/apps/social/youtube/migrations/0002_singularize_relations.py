...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Channel.idols'
        db.delete_column(u'youtube_channel', 'idols_id')

        # Deleting field 'Channel.groups'
        db.delete_column(u'youtube_channel', 'groups_id')

        # Adding field 'Channel.idol'
        db.add_column(u'youtube_channel', 'idol',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='channel', unique=True, null=True, to=orm['people.Idol']),
                      keep_default=False)

        # Adding field 'Channel.group'
        db.add_column(u'youtube_channel', 'group',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='channel', unique=True, null=True, to=orm['people.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Channel.idols'
        db.add_column(u'youtube_channel', 'idols',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='channel', unique=True, null=True, to=orm['people.Idol'], blank=True),
                      keep_default=False)

        # Adding field 'Channel.groups'
        db.add_column(u'youtube_channel', 'groups',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='channel', unique=True, null=True, to=orm['people.Group'], blank=True),
                      keep_default=False)

        # Deleting field 'Channel.idol'
        db.delete_column(u'youtube_channel', 'idol_id')

        # Deleting field 'Channel.group'
        db.delete_column(u'youtube_channel', 'group_id')
