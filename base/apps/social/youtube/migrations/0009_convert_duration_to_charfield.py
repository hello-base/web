...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'youtube_video', 'duration', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Video.duration'
        db.alter_column(u'youtube_video', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True))
