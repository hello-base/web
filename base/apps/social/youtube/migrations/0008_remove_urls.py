...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.flash_url'
        db.delete_column(u'youtube_video', 'flash_url')

        # Deleting field 'Video.watch_url'
        db.delete_column(u'youtube_video', 'watch_url')


    def backwards(self, orm):
        # Adding field 'Video.flash_url'
        db.add_column(u'youtube_video', 'flash_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Video.watch_url'
        db.add_column(u'youtube_video', 'watch_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 0, 0)', 'blank': 'True'}),
        ...
        u'youtube.channel': {
            ...
            'ytid': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '60'})
        },
        u'youtube.thumbnail': {
