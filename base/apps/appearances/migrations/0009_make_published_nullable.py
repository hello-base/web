...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'appearances_issue', 'published', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Issue.published'
        raise RuntimeError("Cannot reverse this migration. 'Issue.published' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Issue.published'
        db.alter_column(u'appearances_issue', 'published', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'appearances.issue': {
            ...
            'published': ('django.db.models.fields.DateField', [], {'null': 'True'}),
