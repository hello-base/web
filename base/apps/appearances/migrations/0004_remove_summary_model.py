...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'appearances_summary', (
            ...
            ('submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'summary_submissions', null=True, to=orm['accounts.Editor'], blank=True)),
            ('episode', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'summaries', null=True, to=orm['appearances.Episode'], blank=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'summaries', null=True, to=orm['appearances.Issue'], blank=True)),
