...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'music_track', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tracks', null=True, to=orm['music.Album']),
                      keep_default=False)

        # Adding field 'Track.single'
        db.add_column(u'music_track', 'single',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tracks', null=True, to=orm['music.Single']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.album'
        db.delete_column(u'music_track', 'album_id')

        # Deleting field 'Track.single'
        db.delete_column(u'music_track', 'single_id')
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 0, 0)', 'blank': 'True'}),
