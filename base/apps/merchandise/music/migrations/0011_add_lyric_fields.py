...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'music_track', 'lyrics',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Track.romanized_lyrics'
        db.add_column(u'music_track', 'romanized_lyrics',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Track.translated_lyrics'
        db.add_column(u'music_track', 'translated_lyrics',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'music_track', 'lyrics')

        # Deleting field 'Track.romanized_lyrics'
        db.delete_column(u'music_track', 'romanized_lyrics')

        # Deleting field 'Track.translated_lyrics'
        db.delete_column(u'music_track', 'translated_lyrics')
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 12, 0, 0)', 'blank': 'True'}),
