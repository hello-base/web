...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.note'
        db.add_column(u'music_album', 'note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Single.note'
        db.add_column(u'music_single', 'note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.note'
        db.delete_column(u'music_album', 'note')

        # Deleting field 'Single.note'
        db.delete_column(u'music_single', 'note')
