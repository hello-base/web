...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.art'
        db.add_column(u'music_album', 'art',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Single.art'
        db.add_column(u'music_single', 'art',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.art'
        db.delete_column(u'music_album', 'art')

        # Deleting field 'Single.art'
        db.delete_column(u'music_single', 'art')
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 9, 0, 0)', 'blank': 'True'}),
