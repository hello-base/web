...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Album.uuid'
        db.alter_column(u'music_album', 'uuid', self.gf('ohashi.db.models.fields.uuids.UUIDField')())

        # Changing field 'Single.uuid'
        db.alter_column(u'music_single', 'uuid', self.gf('ohashi.db.models.fields.uuids.UUIDField')())
