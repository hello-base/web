...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'TrackOrder.is_album_track' to 'is_album_only'
        db.rename_column(u'music_trackorder', 'is_album_track', 'is_album_only')


    def backwards(self, orm):
        # Renaming field 'TrackOrder.is_album_only' to 'is_album_track'
        db.rename_column(u'music_trackorder', 'is_album_only', 'is_album_track')
