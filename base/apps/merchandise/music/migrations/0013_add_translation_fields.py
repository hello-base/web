...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Track.translated_name'
        db.add_column(u'music_track', 'translated_name',
                      self.gf('ohashi.db.models.fields.CharField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Track.translation_notes'
        db.add_column(u'music_track', 'translation_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.translated_name'
        db.delete_column(u'music_track', 'translated_name')

        # Deleting field 'Track.translation_notes'
        db.delete_column(u'music_track', 'translation_notes')
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 0, 0)', 'blank': 'True'}),
        ...
        u'music.track': {
            ...
            'translated_name': ('ohashi.db.models.fields.CharField', [], {'blank': 'True'}),
        ...
        u'music.trackorder': {
            'Meta': {'ordering': "('position',)", 'unique_together': "(('edition', 'track', 'is_instrumental'),)", 'object_name': 'TrackOrder'},
