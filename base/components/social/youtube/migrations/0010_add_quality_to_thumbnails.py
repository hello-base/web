...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Thumbnail.quality'
        db.add_column(u'youtube_thumbnail', 'quality',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Thumbnail.quality'
        db.delete_column(u'youtube_thumbnail', 'quality')
    ...
    models = {
        ...
        u'youtube.thumbnail': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quality': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '10'}),
