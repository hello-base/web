...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'youtube_video', u'id')


        # Changing field 'Video.ytid'
        db.alter_column(u'youtube_video', 'ytid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200, primary_key=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Video.id'
        raise RuntimeError("Cannot reverse this migration. 'Video.id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Video.id'
        db.add_column(u'youtube_video', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # Changing field 'Video.ytid'
        db.alter_column(u'youtube_video', 'ytid', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True))
    ...
    models = {
        ...
        u'youtube.channel': {
            ...
            'group': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'channel'", 'unique': 'True', 'null': 'True', 'to': u"orm['people.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idol': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'channel'", 'unique': 'True', 'null': 'True', 'to': u"orm['people.Idol']"}),
        ...
        u'youtube.video': {
            ...
            'ytid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200', 'primary_key': 'True'})
        }
    }
