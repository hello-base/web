...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Update.date'
        db.delete_column(u'news_update', 'date')

        # Adding field 'Update.published'
        db.add_column(u'news_update', 'published',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 4, 0, 0)),
                      keep_default=False)

        # Deleting field 'Item.date'
        db.delete_column(u'news_item', 'date')

        # Adding field 'Item.published'
        db.add_column(u'news_item', 'published',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 4, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Update.date'
        db.add_column(u'news_update', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 4, 0, 0)),
                      keep_default=False)

        # Deleting field 'Update.published'
        db.delete_column(u'news_update', 'published')

        # Adding field 'Item.date'
        db.add_column(u'news_item', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 4, 0, 0)),
                      keep_default=False)

        # Deleting field 'Item.published'
        db.delete_column(u'news_item', 'published')
