...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.classification'
        db.add_column(u'news_item', 'classification',
                      self.gf('django.db.models.fields.CharField')(default=u'normal', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.classification'
        db.delete_column(u'news_item', 'classification')
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 5, 0, 0)', 'blank': 'True'}),
        ...
        u'news.item': {
            ...
            'published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 5, 0, 0)'}),
