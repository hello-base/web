...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field shows on 'Item'
        m2m_table_name = db.shorten_name(u'news_item_shows')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'news.item'], null=False)),
            ('show', models.ForeignKey(orm[u'appearances.show'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'show_id'])

        # Adding M2M table for field magazines on 'Item'
        m2m_table_name = db.shorten_name(u'news_item_magazines')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'news.item'], null=False)),
            ('magazine', models.ForeignKey(orm[u'appearances.magazine'], null=False))
        ))
        db.create_unique(m2m_table_name, ['item_id', 'magazine_id'])


    def backwards(self, orm):
        # Removing M2M table for field shows on 'Item'
        db.delete_table(db.shorten_name(u'news_item_shows'))

        # Removing M2M table for field magazines on 'Item'
        db.delete_table(db.shorten_name(u'news_item_magazines'))
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 7, 0, 0)', 'blank': 'True'}),
        ...
        u'news.item': {
            ...
            u'albums': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['music.Album']"}),
            ...
            'classification': ('django.db.models.fields.CharField', [], {'default': "u'normal'", 'max_length': '16'}),
            u'events': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['events.Event']"}),
            u'groups': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['people.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'idols': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['people.Idol']"}),
            u'magazines': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['appearances.Magazine']"}),
            'published': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 7, 0, 0)'}),
            u'shows': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['appearances.Show']"}),
            u'singles': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'items'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['music.Single']"}),
