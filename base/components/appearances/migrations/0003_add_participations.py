...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field idols on 'Issue'
        m2m_table_name = db.shorten_name(u'appearances_issue_idols')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm[u'appearances.issue'], null=False)),
            ('idol', models.ForeignKey(orm[u'people.idol'], null=False))
        ))
        db.create_unique(m2m_table_name, ['issue_id', 'idol_id'])

        # Adding M2M table for field groups on 'Issue'
        m2m_table_name = db.shorten_name(u'appearances_issue_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm[u'appearances.issue'], null=False)),
            ('group', models.ForeignKey(orm[u'people.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['issue_id', 'group_id'])

        # Adding M2M table for field participating_idols on 'Issue'
        m2m_table_name = db.shorten_name(u'appearances_issue_participating_idols')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm[u'appearances.issue'], null=False)),
            ('idol', models.ForeignKey(orm[u'people.idol'], null=False))
        ...
        # Adding M2M table for field participating_groups on 'Issue'
        m2m_table_name = db.shorten_name(u'appearances_issue_participating_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm[u'appearances.issue'], null=False)),
            ('group', models.ForeignKey(orm[u'people.group'], null=False))
        ...
        # Adding M2M table for field idols on 'Episode'
        m2m_table_name = db.shorten_name(u'appearances_episode_idols')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('episode', models.ForeignKey(orm[u'appearances.episode'], null=False)),
            ('idol', models.ForeignKey(orm[u'people.idol'], null=False))
        ))
        db.create_unique(m2m_table_name, ['episode_id', 'idol_id'])

        # Adding M2M table for field groups on 'Episode'
        m2m_table_name = db.shorten_name(u'appearances_episode_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('episode', models.ForeignKey(orm[u'appearances.episode'], null=False)),
            ('group', models.ForeignKey(orm[u'people.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['episode_id', 'group_id'])

        # Adding M2M table for field participating_idols on 'Episode'
        m2m_table_name = db.shorten_name(u'appearances_episode_participating_idols')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('episode', models.ForeignKey(orm[u'appearances.episode'], null=False)),
            ('idol', models.ForeignKey(orm[u'people.idol'], null=False))
        ...
        # Adding M2M table for field participating_groups on 'Episode'
        m2m_table_name = db.shorten_name(u'appearances_episode_participating_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('episode', models.ForeignKey(orm[u'appearances.episode'], null=False)),
            ('group', models.ForeignKey(orm[u'people.group'], null=False))
    ...
    def backwards(self, orm):
        # Removing M2M table for field idols on 'Issue'
        db.delete_table(db.shorten_name(u'appearances_issue_idols'))

        # Removing M2M table for field groups on 'Issue'
        db.delete_table(db.shorten_name(u'appearances_issue_groups'))

        # Removing M2M table for field participating_idols on 'Issue'
        db.delete_table(db.shorten_name(u'appearances_issue_participating_idols'))

        # Removing M2M table for field participating_groups on 'Issue'
        db.delete_table(db.shorten_name(u'appearances_issue_participating_groups'))

        # Removing M2M table for field idols on 'Episode'
        db.delete_table(db.shorten_name(u'appearances_episode_idols'))

        # Removing M2M table for field groups on 'Episode'
        db.delete_table(db.shorten_name(u'appearances_episode_groups'))

        # Removing M2M table for field participating_idols on 'Episode'
        db.delete_table(db.shorten_name(u'appearances_episode_participating_idols'))

        # Removing M2M table for field participating_groups on 'Episode'
        db.delete_table(db.shorten_name(u'appearances_episode_participating_groups'))
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 18, 0, 0)', 'blank': 'True'}),
