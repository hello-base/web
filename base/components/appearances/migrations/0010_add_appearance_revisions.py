...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'appearances_issue', 'published')

        # Adding field 'Issue.volume_month'
        db.add_column(u'appearances_issue', 'volume_month',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.volume_week'
        db.add_column(u'appearances_issue', 'volume_week',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CardSet.name'
        db.add_column(u'appearances_cardset', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Episode.is_coverage'
        db.add_column(u'appearances_episode', 'is_coverage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Episode.video_link'
        db.alter_column(u'appearances_episode', 'video_link', self.gf('django.db.models.fields.URLField')(max_length=500))

    def backwards(self, orm):
        # Adding field 'Issue.published'
        db.add_column(u'appearances_issue', 'published',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Deleting field 'Issue.volume_month'
        db.delete_column(u'appearances_issue', 'volume_month')

        # Deleting field 'Issue.volume_week'
        db.delete_column(u'appearances_issue', 'volume_week')

        # Deleting field 'CardSet.name'
        db.delete_column(u'appearances_cardset', 'name')

        # Deleting field 'Episode.is_coverage'
        db.delete_column(u'appearances_episode', 'is_coverage')


        # Changing field 'Episode.video_link'
        db.alter_column(u'appearances_episode', 'video_link', self.gf('django.db.models.fields.URLField')(max_length=200))

    models = {
        u'accounts.editor': {
            'Meta': {'object_name': 'Editor'},
            'access_token': ('ohashi.db.models.fields.CharField', [], {'blank': 'True'}),
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)', 'blank': 'True'}),
        ...
        u'appearances.episode': {
            ...
            'is_coverage': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'video_link': ('django.db.models.fields.URLField', [], {'max_length': '500', 'blank': 'True'})
        },
        u'appearances.issue': {
