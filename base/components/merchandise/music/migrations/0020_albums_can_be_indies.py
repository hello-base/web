...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.is_indie'
        db.add_column(u'music_album', 'is_indie',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.is_indie'
        db.delete_column(u'music_album', 'is_indie')
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 21, 0, 0)', 'blank': 'True'}),
