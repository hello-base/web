...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.released_as'
        db.add_column(u'music_album', 'released_as',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Album.romanized_released_as'
        db.add_column(u'music_album', 'romanized_released_as',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Single.released_as'
        db.add_column(u'music_single', 'released_as',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Single.romanized_released_as'
        db.add_column(u'music_single', 'romanized_released_as',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.released_as'
        db.delete_column(u'music_album', 'released_as')

        # Deleting field 'Album.romanized_released_as'
        db.delete_column(u'music_album', 'romanized_released_as')

        # Deleting field 'Single.released_as'
        db.delete_column(u'music_single', 'released_as')

        # Deleting field 'Single.romanized_released_as'
        db.delete_column(u'music_single', 'romanized_released_as')
