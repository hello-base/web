...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Track.processed_lyrics'
        db.add_column(u'music_track', 'processed_lyrics',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Track.processed_romanized_lyrics'
        db.add_column(u'music_track', 'processed_romanized_lyrics',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Track.processed_translated_lyrics'
        db.add_column(u'music_track', 'processed_translated_lyrics',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.processed_lyrics'
        db.delete_column(u'music_track', 'processed_lyrics')

        # Deleting field 'Track.processed_romanized_lyrics'
        db.delete_column(u'music_track', 'processed_romanized_lyrics')

        # Deleting field 'Track.processed_translated_lyrics'
        db.delete_column(u'music_track', 'processed_translated_lyrics')
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 9, 0, 0)', 'blank': 'True'}),
        ...
        u'music.track': {
            ...
            'processed_lyrics': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'processed_romanized_lyrics': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'processed_translated_lyrics': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
