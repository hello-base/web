...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Track.original_track'
        db.add_column(u'music_track', 'original_track',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent', null=True, to=orm['music.Track']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.original_track'
        db.delete_column(u'music_track', 'original_track_id')
