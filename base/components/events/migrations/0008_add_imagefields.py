...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_venue', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.logo'
        db.add_column(u'events_event', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Event.stage'
        db.add_column(u'events_event', 'stage',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'events_venue', 'photo')

        # Deleting field 'Event.logo'
        db.delete_column(u'events_event', 'logo')

        # Deleting field 'Event.poster'
        db.delete_column(u'events_event', 'poster')

        # Deleting field 'Event.stage'
        db.delete_column(u'events_event', 'stage')
