...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'events_activity', (
            ...
            ('submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='activity_submissions', null=True, to=orm['accounts.Editor'], blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('venue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='activities', null=True, to=orm['events.Venue'], blank=True)),
