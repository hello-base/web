...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Performance.end_time'
        db.delete_column(u'events_performance', 'end_time')


    def backwards(self, orm):
        # Adding field 'Performance.end_time'
        db.add_column(u'events_performance', 'end_time',
