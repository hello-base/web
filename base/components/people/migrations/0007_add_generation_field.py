...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.generation'
        db.add_column(u'people_membership', 'generation',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.generation'
        db.delete_column(u'people_membership', 'generation')
