...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.submitted_by'
        db.add_column(u'people_group', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='group_submissions', null=True, to=orm['accounts.Editor']),
                      keep_default=False)

        # Adding M2M table for field edited_by on 'Group'
        m2m_table_name = db.shorten_name(u'people_group_edited_by')
        ...
        db.create_unique(m2m_table_name, ['group_id', 'editor_id'])

        # Adding field 'Idol.submitted_by'
        db.add_column(u'people_idol', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='idol_submissions', null=True, to=orm['accounts.Editor']),
                      keep_default=False)

        # Adding M2M table for field edited_by on 'Idol'
        m2m_table_name = db.shorten_name(u'people_idol_edited_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('idol', models.ForeignKey(orm[u'people.idol'], null=False)),
            ('editor', models.ForeignKey(orm[u'accounts.editor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['idol_id', 'editor_id'])

        # Adding field 'Staff.submitted_by'
        db.add_column(u'people_staff', 'submitted_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='staff_submissions', null=True, to=orm['accounts.Editor']),
                      keep_default=False)

        # Adding M2M table for field edited_by on 'Staff'
        m2m_table_name = db.shorten_name(u'people_staff_edited_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('staff', models.ForeignKey(orm[u'people.staff'], null=False)),
            ('editor', models.ForeignKey(orm[u'accounts.editor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['staff_id', 'editor_id'])


    def backwards(self, orm):
        # Deleting field 'Group.submitted_by'
        db.delete_column(u'people_group', 'submitted_by_id')

        # Removing M2M table for field edited_by on 'Group'
        db.delete_table(db.shorten_name(u'people_group_edited_by'))

        # Deleting field 'Idol.submitted_by'
        db.delete_column(u'people_idol', 'submitted_by_id')

        # Removing M2M table for field edited_by on 'Idol'
        db.delete_table(db.shorten_name(u'people_idol_edited_by'))

        # Deleting field 'Staff.submitted_by'
        db.delete_column(u'people_staff', 'submitted_by_id')

        # Removing M2M table for field edited_by on 'Staff'
        db.delete_table(db.shorten_name(u'people_staff_edited_by'))
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 20, 0, 0)', 'blank': 'True'}),
