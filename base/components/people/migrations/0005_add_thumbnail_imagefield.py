...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Groupshot.photo_thumbnail'
        db.add_column(u'people_groupshot', 'photo_thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Group.photo_thumbnail'
        db.add_column(u'people_group', 'photo_thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Idol.photo_thumbnail'
        db.add_column(u'people_idol', 'photo_thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Headshot.photo_thumbnail'
        db.add_column(u'people_headshot', 'photo_thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Groupshot.photo_thumbnail'
        db.delete_column(u'people_groupshot', 'photo_thumbnail')

        # Deleting field 'Group.photo_thumbnail'
        db.delete_column(u'people_group', 'photo_thumbnail')

        # Deleting field 'Idol.photo_thumbnail'
        db.delete_column(u'people_idol', 'photo_thumbnail')

        # Deleting field 'Headshot.photo_thumbnail'
        db.delete_column(u'people_headshot', 'photo_thumbnail')
