...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Idol.started'
        db.add_column(u'people_idol', 'started',
                      self.gf('django.db.models.fields.DateField')(null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Idol.graduated'
        db.add_column(u'people_idol', 'graduated',
                      self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Idol.retired'
        db.add_column(u'people_idol', 'retired',
                      self.gf('django.db.models.fields.DateField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Idol.started'
        db.delete_column(u'people_idol', 'started')

        # Deleting field 'Idol.graduated'
        db.delete_column(u'people_idol', 'graduated')

        # Deleting field 'Idol.retired'
        db.delete_column(u'people_idol', 'retired')
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 22, 0, 0)', 'blank': 'True'}),
