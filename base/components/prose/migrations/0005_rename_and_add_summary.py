...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming model 'Fact'
        db.rename_table(u'facts_fact', u'prose_fact')
        ...
        db.create_table(u'prose_summary', (
            ...
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'summaries', null=True, to=orm['events.Activity'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'summaries', null=True, to=orm['events.Event'])),
            ('performance', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'summaries', null=True, to=orm['events.Performance'])),
        ...
        db.send_create_signal(u'prose', ['Summary'])


    def backwards(self, orm):
        # Renaming model 'Fact'
        db.rename_table(u'prose_fact', 'facts_fact')

        # Deleting model 'Summary'
        db.delete_table(u'prose_summary')
    ...
    models = {
        ...
        u'prose.fact': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'facts'", 'null': 'True', 'to': u"orm['music.Album']"}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'facts'", 'null': 'True', 'to': u"orm['events.Event']"}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'facts'", 'null': 'True', 'to': u"orm['people.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idol': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'facts'", 'null': 'True', 'to': u"orm['people.Idol']"}),
            'performance': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'facts'", 'null': 'True', 'to': u"orm['events.Performance']"}),
            'single': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'facts'", 'null': 'True', 'to': u"orm['music.Single']"})
        },
        u'prose.summary': {
            'Meta': {'object_name': 'Summary'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'summaries'", 'null': 'True', 'to': u"orm['events.Activity']"}),
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'summaries'", 'null': 'True', 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'performance': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'summaries'", 'null': 'True', 'to': u"orm['events.Performance']"}),
