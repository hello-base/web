...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fact.album'
        db.add_column(u'facts_fact', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='facts', null=True, to=orm['music.Album']),
                      keep_default=False)

        # Adding field 'Fact.single'
        db.add_column(u'facts_fact', 'single',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='facts', null=True, to=orm['music.Single']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fact.album'
        db.delete_column(u'facts_fact', 'album_id')

        # Deleting field 'Fact.single'
        db.delete_column(u'facts_fact', 'single_id')
    ...
    models = {
        u'accounts.editor': {
            ...
            'active_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 23, 0, 0)', 'blank': 'True'}),
