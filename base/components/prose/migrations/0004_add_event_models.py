...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fact.event'
        db.add_column(u'facts_fact', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='facts', null=True, to=orm['events.Event']),
                      keep_default=False)

        # Adding field 'Fact.performance'
        db.add_column(u'facts_fact', 'performance',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='facts', null=True, to=orm['events.Performance']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fact.event'
        db.delete_column(u'facts_fact', 'event_id')

        # Deleting field 'Fact.performance'
        db.delete_column(u'facts_fact', 'performance_id')
    ...
    models = {
        ...
        u'facts.fact': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'facts'", 'null': 'True', 'to': u"orm['music.Album']"}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'facts'", 'null': 'True', 'to': u"orm['events.Event']"}),
            ...
            'performance': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'facts'", 'null': 'True', 'to': u"orm['events.Performance']"}),
            'single': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'facts'", 'null': 'True', 'to': u"orm['music.Single']"})
        },
        u'music.album': {
